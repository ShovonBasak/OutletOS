...
class FinanceServiceTests(TestCase):
    def setUp(self):
        self.org = Organization.objects.create(name="Test Org", slug="test-org-finance-services")
    ...
    def test_transfer_pair_true_atomicity_on_failure(self):
        ...
        bogus = FinancialAccount(id=999999, account_type="BANK", name="ghost", organization=self.org,
